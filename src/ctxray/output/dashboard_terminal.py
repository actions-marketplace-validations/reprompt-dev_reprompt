"""Rich terminal rendering for the dashboard (bare `ctxray` command)."""
...
def _render_zero_state(console: Console, data: DashboardData) -> str:
    ...
    if data.discoveries:
        ...
        console.print(table)
        console.print()
        console.print("  [bold cyan]ctxray scan[/bold cyan]  — import all and analyze your prompts")
        ...
        console.print("  Run [bold cyan]ctxray scan --help[/bold cyan] to get started.")
